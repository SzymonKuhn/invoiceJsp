...
//            Query<Student> query = session.createQuery("from Student", Student.class);//HQL
            ...
            //narzędzie do kreowania zaoytania, do tworzenia query i budowania klauzuli where
            ...
            //wykonanie selecta z tabeli
            criteriaQuery.select(rootTable);

            //wywołujemy zapytanie i zbieramy do listy
...
//            list.addAll(query.list());
    ...
    public <T extends IBaseEntity> void delete (Class<T> classT, Long id) {
        ...
        if (entityOptional.isPresent()) {
            ...
            System.err.println("Nie udało się usunąć instancji");
        }
    }
